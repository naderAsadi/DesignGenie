...
from src import ADESegmentationModel, ControlNetInpaintPipeline, WandBLogger, parser
...
def main(args):
    ...
    segmentation_model = ADESegmentationModel(model_name=args.segmentation_model)

    # Load controlnet
    pipeline = ControlNetInpaintPipeline(
